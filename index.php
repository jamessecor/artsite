...
<div class="row store-row">
	...
	<div class="col-md-4">
		<img width="25%" src="http://jamessecor.com/img/AtMyWitsEnd2018.jpg"/>
		<img width="25%" src="http://jamessecor.com/img/IMG_20200308_112616.jpg"/>
        <img width="25%" src="http://jamessecor.com/img/animalMug_dish_andGlass_I.jpg"/>
        <img width="25%" src="http://jamessecor.com/img/barcodes2019.jpg"/>
        <img width="25%" src="http://jamessecor.com/img/teacup.jpg"/>
        <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" >
        <input type="hidden" name="cmd" value="_cart">
        <input type="hidden" name="business" value="james.secor@gmail.com">
        <input type="hidden" name="lc" value="US">
