...
<div class="row">
	<div class="col-md-10 col-md-offset-1 center-it show-title">
		Two New Shows by James Secor
	</div>
</div>
...
<div class="row">
	<div class="col-md-3 col-md-offset-3 center-it">
		<img  src="../img/Units AV-AZ_2018.jpg"  alt="Could not retrieve image"/>
	</div>
</div>
<div class="row">
	<div class="col-md center-it">
		<p>
			<strong><em><a href="./asnotseen" target="blank">As Not Seen</a></em></strong>
			<br>at Sterling College's Brown Library
			<br>N Craftsbury Rd, Craftsbury, VT
			<br>Opens in November. <em>[dates TBD]</em>
			<!--<br>November xx - January xx (2018-2019)--
		</p>
	</div>
</div>

<!-- Driving up a Chimney --
<div class="row">
	<div class="col-md-4 col-md-offset-4">
		<img class="current-show-img" src="../img/boston.jpg"  alt="Could not retrieve image"/>
	</div>
</div>
<div class="row">
	<div class="col-md center-it">		
		<p>
			<strong><em>Driving Up a Chimney</em></strong>
			<br>at the Center for Arts and Learning
			<br>46 Barre St, Montpelier, VT
			<br>Opens in December. <em>[dates TBD]</em>
			<!--<br>November xx - January xx (2018-2019)--
		</p>
